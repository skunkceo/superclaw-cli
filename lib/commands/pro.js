...
function installPro(workspace, licenseKey) {
  ...
  if (!isValid) {
    ...
    console.log(`\nGet a license at: ${colors.blue}https://skunkglobal.com/checkout?product=superclaw-pro${colors.reset}\n`);
    process.exit(1);
  }
...
function showStatus(workspace) {
  ...
  if (license.valid && license.tier === 'pro') {
    ...
    console.log(`\n${colors.blue}https://skunkglobal.com/checkout?product=superclaw-pro${colors.reset}`);
  }
