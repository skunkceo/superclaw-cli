...
async function installDashboard() {
  ...
  try {
    ...
    if (!setupNow.toLowerCase().startsWith('n')) {
      ...
      console.log(`\n${colors.bright}🚀 Ready to start!${colors.reset}\n`);
      console.log(`Run this command to start your dashboard:\n`);
      console.log(`  ${colors.cyan}cd ${installDir} && npm start${colors.reset}\n`);
      console.log(`Then open: ${colors.blue}http://localhost:3077${colors.reset}\n`);
    } else {
