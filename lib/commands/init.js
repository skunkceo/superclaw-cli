  ...
  try {
    ...
    if (!setupNow.toLowerCase().startsWith('n')) {
      ...
      if (!startNow.toLowerCase().startsWith('n')) {
        ...
        info('This may take a moment while the dashboard builds and starts...\n');
        ...
        // Wait for Next.js to build and start (usually 5-10 seconds)
        console.log(`${colors.dim}Waiting for dashboard to start...${colors.reset}`);
